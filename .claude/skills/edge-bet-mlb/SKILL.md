---
name: edge-bet-mlb
description: Quick-fire MLB betting — scans tomorrow's MLB games for edge and executes bets with preset defaults.
...
Quick-fire MLB betting with preset defaults. Scans for edge, shows preview, then executes on confirmation.
