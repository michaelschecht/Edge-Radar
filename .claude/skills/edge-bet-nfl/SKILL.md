---
name: edge-bet-nfl
description: Quick-fire NFL betting — scans tomorrow's NFL games for edge and executes bets with preset defaults.
...
Quick-fire NFL betting with preset defaults. Scans for edge, shows preview, then executes on confirmation.
