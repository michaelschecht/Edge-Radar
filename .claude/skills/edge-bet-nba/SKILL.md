---
name: edge-bet-nba
description: Quick-fire NBA betting — scans tomorrow's NBA games for edge and executes bets with preset defaults.
...
Quick-fire NBA betting with preset defaults. Scans for edge, shows preview, then executes on confirmation.
