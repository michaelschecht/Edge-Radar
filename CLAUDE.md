...
MIN_EDGE_THRESHOLD_NBA=0.08     # Per-sport override (R14, 2026-04-24 — NBA Brier 0.3306 worst sport; 0.12 proposed but 0.08 adopted)
MIN_EDGE_THRESHOLD_NCAAB=0.08   # Per-sport override (optional)
MIN_EDGE_THRESHOLD_MLB=0.08     # Per-sport override (2026-06-03 — MLB 40% WR / -12% ROI, model over-claims ~15% edge)
