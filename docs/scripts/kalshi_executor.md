...
| 3 | Edge threshold | Must meet per-sport floor or `MIN_EDGE_THRESHOLD` global (3% default; MLB/NBA/NCAAB 4% [2026-06-14, lowered from 0.06]). Rejection message shows the floor in use. |
